/* ==========================================================================
   ...
   ========================================================================== */
import { initOneDriveModalListener } from "./components/onedrive-modal.js?v=20260925.FINAL";
import { db } from "./services/db.js?v=20260925.FINAL";
import { renderWelcomePage } from "./pages/welcome.js?v=20260925.FINAL";
import { renderSidebar } from "./components/sidebar.js?v=20260925.FINAL";
import { renderHeader } from "./components/header.js?v=20260925.FINAL";

// Páginas cargadas dinámicamente
import { renderDashboardPage } from "./pages/dashboard.js?v=20260925.FINAL";
import { renderMallaPage } from "./pages/malla.js?v=20260925.FINAL";
import { renderPlanPage } from "./pages/plan.js?v=20260925.FINAL";
import { renderEvidenciasPage } from "./pages/evidencias.js?v=20260925.FINAL";

import { renderEncuestasPage } from "./pages/encuestas.js?v=20260925.FINAL";
import { renderPromptsPage } from "./pages/prompts.js?v=20260925.FINAL";
import { renderUsuariosPage } from "./pages/usuarios.js?v=20260925.FINAL";
import { renderSolicitudesPage } from "./pages/solicitudes.js?v=20260925.FINAL";
import { renderAsesorSuneduPage } from "./pages/asesor_sunedu.js?v=20260925.FINAL";
import { renderMonitoreoPage } from "./pages/monitoreo.js?v=20260925.FINAL";
import { renderTransparenciaPage } from "./pages/transparencia.js?v=20260925.FINAL";
import { renderTransparenciaCbcPage } from "./pages/transparencia_cbc.js?v=20260925.FINAL";
